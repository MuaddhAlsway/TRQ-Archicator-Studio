...
async function check() {
  console.log('🔍 CHECKING SETTINGS WITH IMAGE PATHS\n');
  ...
  console.log(`Found ${settings.length} settings with image/video paths:\n`);
  
  settings.forEach(s => {
    const isAbsolute = s.value && (s.value.startsWith('https://') || s.value.startsWith('http://'));
