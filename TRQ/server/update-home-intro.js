...
console.log('\n🔄 Updating Home Intro Text...\n');

const updates = [
  // Arabic
  {
    key: 'homeIntroTitle_ar',
    value: 'نصنع حلول تصميم خالدة'
  },
  {
    key: 'homeIntroText1_ar',
  ...
  {
    key: 'homeIntroTitle',
    value: 'We Create Lasting Design Solutions'
  },
  {
    key: 'homeIntroText1',
...
try {
  ...
  console.log('\n✅ Home intro text updated successfully!\n');
} catch (error) {
