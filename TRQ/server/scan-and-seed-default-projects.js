...
const projectsMetadata = {
  ...
  'DIRIYAH NATIONAL DAY EVENT': {
    ...
    subcategory_ar: 'تصميم الحدث',
    description: 'Grand national day celebration event design with cultural significance.',
    description_ar: 'تصميم حدث احتفالي وطني كبير بأهمية ثقافية.',
    year: '2023',
    client: 'Diriyah Development Authority',
    client_ar: 'هيئة تطوير الدرعية',
    location: 'Diriyah, Saudi Arabia',
